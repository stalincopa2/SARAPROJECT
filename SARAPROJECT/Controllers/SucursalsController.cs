...
namespace SARAPROJECT.Controllers
{
    public class SucursalsController : Controller
    {
        ...
        public SucursalsController(SARADBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdSucursal,Ruc,Nombre,Direccion,Telefono")] Sucursal sucursal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdSucursal,Ruc,Nombre,Direccion,Telefono")] Sucursal sucursal)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SARADBContext.Sucursals'  is null.");
            }
            var sucursal = await _context.Sucursals.FindAsync(id);
            if (sucursal != null)
            {
